...
I also contributed to building a **custom agentic AI platform** during my internship. The platform combines multiple cross-platform tools, custom workflows, and intelligent automation tailored for B2B clients. Check it out here  **SuprAI**  🔗 [Link](https://www.suprai.one/)
